                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input required="" type="text" name="name" value="{{ $siswa->name }}" readonly id="name"
                                    class="form-control">
                                @error('name')
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input required="" type="text" name="nisn" value="{{ $siswa->nisn }}" readonly id="nisn"
                                    class="form-control">
                                @error('nisn')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input required="" type="text" name="kelas" value="{{ $siswa->kelas }}" readonly
